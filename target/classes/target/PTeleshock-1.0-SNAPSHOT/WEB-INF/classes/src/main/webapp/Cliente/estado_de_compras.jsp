        ...
        <main>
            <div class="container-fluid px-4">
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="<%= request.getContextPath()%>/Client_Bolsa_Compra">Bolsa de Compras</a></li>
                            ...
                            <div class="col-sm-4 text-end">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <p class="card-title"><small>Entregado</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <th><img src="img/paltomiel.jpg" class="img-thumbnail" alt="..."
                                         style="width: 100px; height: 100px">PALTOMIEL JARABE ADULTO 200ML</th>
                                <td>
                                    <div id="contenedor2">
                                ...
                                <td><div style=" margin-top: 30px;margin-left: 12px">$ 15.50</div></td>
                            </tr>
                            <tr>
                                <th><img src="img/paltomiel.jpg" class="img-thumbnail" alt="..."
                                         style="width: 100px; height: 100px">PALTOMIEL JARABE NIÑOS 200ML</th>
                                <td>
                                    <div id="contenedor">
                                ...
                                <td><div style=" margin-top: 40px; margin-left: 12px">$ 15.50</div></td>
                            </tr>
                            <tr>
                                <th>
                                    <div id="contenedor1">
                                        <div style=" margin-top: 30px" class="producto">
                                            <span><img class="icon" style="width: 18px; height: 18px;"  src="https://cdn-icons-png.flaticon.com/512/2370/2370264.png"> Fecha y hora de recojo: 20/10/2020 05:10:02 pm</span>
                                            <div class="costo">
                                                <span class="text-center"><img class="icon" style="width: 25px; height: 25px;"  src="https://cdn-icons-png.flaticon.com/512/1564/1564873.png"> San Juan de Miraflores - Farmacia A</span>
                                            </div>
                                        </div>
                                    </div>
                                </th>
                                <td><div class="card-header text-white text-center">Subtotal</div></td>
                                <td><div class="card-header text-white text-center">$31.00 </div></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
