...
public class BPrueba {
    ...
    public BPrueba(int idusuario, int idfarmacia, String nombre, String ruc, String direccion, String correo, String estado, int pedEntregados, int pedPendientes, int pedCancelados, int pedDeseados) {
