                            ...
                            <div class="col-sm-6">
                                <div class="card text-white bg-info mb-3">
                                    <div class="row no-gutters">
                                        <div class="col-md-9">
                                            <div class="card-body">
                                                <h5 class="card-title" style="color: #FFFFFF;text-underline: #FFFFFF">
                                                    <u>Farmacias añadidas</u></h5>
                                                <p class="card-text" style="color: #FFFFFF">Ver todas las farmacias que
                                                    han sido añadidas</p>
                                                <a href="<%= request.getContextPath()%>/Admin_Hist?action=add"
                                                   type="button" class="btn btn-info"
                                                   style="width: 70%;background-color: #059ac5;color: #FFFFFF"><i
                                                        class="fas fa-angle-double-down"></i></a>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="align-content-center" style="padding-top: 35%">
                                                <i class="fas fs-1 fa-clinic-medical"
                                                   style="position: center;color: #059ac5"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-3 text-white bg-warning" style="border-color: #ffc107">
                                    <div class="row no-gutters">
                                        <div class="col-md-9">
                                            <div class="card-body">
                                                <h5 class="card-title" style="color: #FFFFFF;text-underline: #FFFFFF">
                                                    <u>Farmacias bloqueadas</u></h5>
                                                <p class="card-text" style="color: #FFFFFF">Ver todas las farmacias que
                                                    han sido bloqueadas</p>
                                                <p><a href="<%= request.getContextPath()%>/Admin_Hist?action=block"
                                                      type="button" class="btn btn-warning"
                                                      style="width: 70%;background-color: #e3ac07;color: #FFFFFF"><i
                                                        class="fas fa-angle-double-down"></i></a></p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="align-content-center" style="padding-top: 35%">
                                ...
                                <div class="card text-white bg-success mb-3" style="border-color: #198754">
                                    <div class="row no-gutters">
                                        <div class="col-md-9">
                                            <div class="card-body">
                                                <h5 class="card-title" style="color: #FFFFFF;text-underline: #FFFFFF">
                                                    <u>Farmacias desbloqueadas</u></h5>
                                                <p class="card-text" style="color: #FFFFFF">Ver todas las farmacais que
                                                    han sido desbloquedas</p>
                                                <p><a href="<%= request.getContextPath()%>/Admin_Hist?action=unlock"
                                                      type="button" class="btn btn-success"
                                                      style="width: 70%;background-color: #156c43"><i
                                                        class="fas fa-angle-double-down"></i></a></p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="align-content-center" style="padding-top: 35%">
                                                <i class="fas fs-1 fa-lock-open"
                                                   style="position: center;color: #156c43"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
