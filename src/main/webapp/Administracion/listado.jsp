...
<jsp:useBean id="listaFarmacias" scope="request"
             type="java.util.ArrayList<pe.edu.pucp.pteleshock.Beans.BFarmacia>"/><!--Bfarmacia-->
...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main class="clase_principal" style="height:92%">
            <div class="container-fluid px-4">
                ...
                <div class="row  row-cols-4">
                    <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0"
                        ...
                        <div class="input-group">
                            ...
                            <% } %>
                            <button class="btn btn-primary" id="btnNavbarSearch" type="submit" style="background-color: #00152D;border-color: #00152D">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-8">
                        <div class="card bg-primary text-white mb-4" style="color:#FFFFFF; background: #375880">
                            ...
                            <div class="row" style="text-align:left;padding-left: 10px">
                                ...
                                <div class="col-md-6">
                                    <table class="table tabla-pedidos rounded" style="float: left">
                                        ...
                                        <tbody>
                                        <tr>
                                            <th scope="row" class="color-fila" style="background: #FFFFFF">
                                                Entregado
                                            </th>
            ...
            <div class="container-fluid px-4" style="<%= filtrar==0?"":"bottom: 7%;right: 3%;position: absolute"%>">
                <div class="row align-items-center">
                <div class="col align-self-start" ></div>
                <div class="col align-self-center">
                    <a style="position: center"><nav aria-label="Page navigation example" style="align-content: center">
                        <%
                            if (filtrar == 0) {%>
                ...
                <div class="col">
                    <a class="stretched-link;nav-link dropdown toogle" role="button" aria-expanded="false"
                       href="<%=request.getContextPath()%>/Admin_Index">
                        <div class="boton_añadir_escape" style="padding-right: 15px;padding-bottom: 5px"><i class="fas fa-door-open fs-3"></i></div>
                    </a>
                </div>
                </div>
            </div>
