                                            ...
                                            <div class="mt-4 mb-0" style="align-content: center">
                                                <div class="d-grid" style="align-content: center">
                                                    <a class="btn btn-primary"
                                                       href="<%=request.getContextPath()%>/Admin_SearchFarm" style="background-color: #E24E34;
                                                     width: fit-content; margin-left: auto; margin-right: auto;">Nueva
                                                        Búsqueda</a>
                                                    <br>
                                                    <a class="btn btn-primary"
                                                       href="<%=request.getContextPath()%>/Admin_Index"
                                                       style="width: fit-content; margin-left: auto; margin-right: auto;">Ir al Menú Principal</a>
