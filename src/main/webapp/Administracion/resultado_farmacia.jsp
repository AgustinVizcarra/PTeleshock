...
<html lang="en">
    <head>
        ...
        <title>Resultado Farmacia</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main class="clase_buscar-farmacia" style="height: 92%">
                        ...
                        <div class="row">
                            <div class="container">
                                ...
                                border-bottom-left-radius: 2rem; border-bottom-right-radius: 2rem;">
                                            <div>
                                                <img src="img/encabezado_resultado-farmacia.png" width="100%"
                                            ...
                                            <div class="card-body"
                                                ...
                                                <div class="row"
                                                    ...
                                                    <div class="col-md-12">
                                                        <table class="table tabla-resultado rounded"
                                                               style="float: left">
                                                    ...
                                                    <div class="mt-4 mb-0" style="align-content: center">
                                                        <div class="row align-items-center"
                                                            ...
                                                            <a class="btn btn-primary"
                                                               href="<%=request.getContextPath()%>/Admin_SearchFarm"
                                                               style="background-color: #E24E34;
                                                     width: fit-content; margin-left: auto; margin-right: auto;">Nueva
                                                                Búsqueda</a>
                                                            <br>
                                                            <a class="btn btn-primary"
                                                               href="<%=request.getContextPath()%>/Admin_Index"
                                                               style="width: fit-content; margin-left: auto; margin-right: auto;">Menú
                                                                Principal</a>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <footer class="py-4 bg-light mt-auto" style="background: #FA9F9F; height: 8%">
