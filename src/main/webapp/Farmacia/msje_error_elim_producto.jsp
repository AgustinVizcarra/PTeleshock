                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-1 order-lg-1" style="width: 61%">
                        ...
                        <form class="mx-1 mx-md-4">
                            ...
                            <div style="margin-left: 50px">
                                <p style="color: white; font-size: 18px"> El jarabe como forma farmacéutica empleada en formulación magistral tiene como principal utilidad terapéutica la administración de medicamentos en pediatría</p>
                            </div>
                            ...
                            <div style="margin-left: 50px">
                                <p style="color: white; font-size: 18px"> 25 unidades</p>
                            </div>
                            ...
                            <div style="margin-left: 50px">
                                <p style="color: white; font-size: 18px"> 25 Soles C/U</p>
                            </div>
                            ...
                            <div style="margin-left: 50px">
                                <p style="color: white; font-size: 18px"> SI </p>
                            </div>


                            <div   >
                                <div style="float: left">
                                    <a class="btn btn-primary" href="<%= request.getContextPath()%>/Farm_Editar_Inf_Producto" style="margin-left: 80px; margin-top: 30px; background-color: #5bc0de" >Editar Producto</a>
                                </div>
                                <div style="float: left">
