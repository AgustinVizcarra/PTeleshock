                            ...
                            <div class="col-md-10 col-lg-6 col-xl-5 order-1 order-lg-1" style="width: 61%">
                                ...
                                <form class="mx-1 mx-md-4">
                                    ...
                                    <div style="margin-left: 50px">
                                        ...
                                        <p style="color: white; font-size: 18px"> <%=pdetalles.getNombre() %></p>
                                    ...
                                    <div style="margin-left: 50px">
                                        <p style="color: white; font-size: 18px"><%=pdetalles.getDescripcion() %></p>
                                    </div>
                                    ...
                                    <div style="margin-left: 50px">
                                        <p style="color: white; font-size: 18px"> <%=pdetalles.getPreciounitario()%> Soles C/U</p>
                                    </div>
                                    ...
                                    <div>
                                        <div style="float: left">
                                            <a class="btn btn-primary" href="<%= request.getContextPath()%>/Farm_Editar_Inf_Producto?prod=<%=idp%>" style="margin-left: 80px; margin-top: 30px; background-color: #5bc0de" >Editar Producto</a>
                                        </div>
                                        <div style="float: left">
                                            <a class="btn btn-primary" href="#popup1" style="margin-left: 80px; margin-top: 30px; background-color: #d9534f" >Eliminar Producto</a>
                                        </div>
                                    </div>
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example" style="display: flex;justify-content: center">
                            <a href="<%= request.getContextPath()%>/Farm_Detalles_Producto?action=borrar&prod=<%=idp%>" class="btn btn-success mb-2">Sí</a>
    ...
    opacity: 1;">
            <div class=" popup card text-center " style="background-color: white">
                ...
                <div class="card-body">
                    ...
                    <a href="<%= request.getContextPath()%>/Farm_Vista_ProductosServlet"  class="btn btn-success mb-2">Aceptar</a>
                </div>
            </div>
        </nav>
