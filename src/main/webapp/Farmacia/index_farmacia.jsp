...
<html lang="en">
    ...
    <body class="sb-nav-fixed"
          style="background-image: url('img/farmacia_background.PNG'); background-repeat:no-repeat; background-size: cover">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion " style="background-color:#00152D ; opacity: 0.9"
                     id="sidenavAccordion">
                        ...
                        <div class="nav" style="margin-top: 30px">
                            ...
                            <a class="nav-link" style="color: white"
                               href="<%= request.getContextPath()%>/Farm_Gestionar_Pedidos">
                                <div class="sb-nav-link-icon"><i class="fas fa-people-arrows"
                                                                 style="color: #ffffff"></i></div>
                                Gestionar Pedidos
                            </a>
