        ...
        <main>
            <div class="container-fluid px-4 mt-5">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<%= request.getContextPath()%>/Client_Bolsa_Compra">Farmacia A</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card-body">
                            ...
                            <h7 class="card-title">Farmacia B</h7>
                    ...
                    <nav aria-label="Page navigation example">
                        ...
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item"><a class="page-link" href="<%= request.getContextPath()%>/Client_Bolsa_Compra">Paso 1</a></li>
                            <li class="page-item"><a class="page-link" href="<%= request.getContextPath()%>/Client_Resumen_Compratotal">Paso 2</a></li>
                            <li class="page-item">
