                    ...
                    <div class="col-md-10 col-lg-10">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center">
                                <li class="page-item"><a class="page-link" href="<%= request.getContextPath()%>/Client_Bolsa_Compra">Previous</a>
                                </li>
                                <li class="page-item"><a class="page-link" href="<%= request.getContextPath()%>/Client_Bolsa_Compra">Paso
                                    1</a></li>
                                <li class="page-item"><a class="page-link" href="<%= request.getContextPath()%>/Client_Resumen_Compratotal">Paso
                                    2</a></li>
                            </ul>
                        </nav>
                    </div>
