    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Pedido #<%=listaPedido.get(0).getBoletaVenta()%></h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="<%= request.getContextPath()%>/Client_Listado_Producto">Lista de Pedidos</a>
                    </li>
                    <li class="breadcrumb-item active">Pedido #<%=listaPedido.get(0).getBoletaVenta()%></li>
                </ol>
                <div class="card mb-4">
                    <div class="card-body">
                        A continuación, se mostrarán los pedidos realizados por farmacia del pedido #<%=listaPedido.get(0).getBoletaVenta()%>!
                    </div>
                </div>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <%=pedido.getNombreFarmacia()%> </td>
                                    <td class="text-center"><%=pedido.getFechaPedido()%></td>
                                    <td class="text-center"><%=pedido.getFechaEntrega()%></td>
                                    <td> <%=pedido.getEstadoPedido()%></td>
                                    <th><%=pedido.getPrecioTotal()%></th>
                                    <td><a class="btn btn-primary" href="<%= request.getContextPath()%>/Client_Estado_Pendiente?idPG=<%=pedido.getBoletaVenta()%>&idFPd=<%=pedido.getIdFarmacia()%>">Ver
                                        Productos</a></td>
                                </tr>
                                <% } %>
                            </tbody>
