        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4" style="opacity: 0.90;">
                    <div class="card-body">
                        <h1 class=" mt-4"><%=farmacia.getNombreFarmacia()%></h1>


                        <ol class="breadcrumb mb-2">
                            <li class="breadcrumb-item"><a href="<%= request.getContextPath()%>/Client_Farmacias">Farmacias</a></li>
                            <li class="breadcrumb-item active"><%=farmacia.getNombreFarmacia()%></li>
                                        ...
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body p-2">
                                                <div class="text-center">
                                                    <!-- Product name-->
                                                    <h5 class="fw-bolder"><%=listaProd.getNombre()%></h5>
                                                    <!-- Product price-->
                                                    <a>Stock: <%=listaProd.getStock()%></a>
                                                    <br>
                                                    <a>S/. <%=listaProd.getPreciounitario()%></a>
                                                </div>
                                            </div>
                                            <!-- Product actions-->
                                            <div class="card-footer p-2 pt-0 border-top-0 bg-transparent text-center">

                                                <form method="POST" action="<%=request.getContextPath()%>/Client_Bolsa_Compra?action=agregar">
                                                    <input type="hidden" class="form-control" name="idProd" value="<%=listaProd.getIdProducto()%>">
                                                    <input type="hidden" class="form-control" name="cantidad" value="1">
                                                    <input type="hidden" class="form-control" name="idFarmacia" value="<%=farmacia.getIdFarmacia()%>">
                                                    <input type="hidden" class="form-control" name="receta" value="<%=listaProd.isRecetaMedicaB()?"1":"0"%>">


                                                    <button class="btn btn-outline-dark mt-auto" href="#popup1" type="submit" >Agregar
                                                    </button>
                                                </form>
...
<nav id="popup1" class="overlay">
    <div class=" popup card text-center ">
        ...
        <div class="card-body">
            ...
            <a href="<%= request.getContextPath()%>/Client_Bolsa_Compra" class="btn btn-warning mb-2">Ir a la bolsa de compras</a>
